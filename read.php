			  ...
			  <div class="box box-solid">
				...
				<div class="box-body no-padding">
				  <ul class="nav nav-pills nav-stacked">
					...
					<li class="active"><a href="read.php"><i class="fa fa-envelope-o"></i> Read
...
<?php
			...
			for($i=0;$i<count($_subject_);$i++){
					echo  '<tr>
							<td><input type="checkbox" class="addAttr_'.$i.'" value="'.$_inbox_pk_[$i].'"></td>
							<td class="mailbox-name"><a href="read-sms.php?id='.$_inbox_pk_[$i].'">'.$_subject_[$i].'</a></td>
							<td class="mailbox-date">'.$_time_[$i].'</td>
						  </tr>';
			}
?>						  
						  </tbody>
