...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><!--<b>UAIS</b>--><!--<img src="dist/img/ico_.png" alt="img-logo">--></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p><?php echo capitalFirstLetter(getField('fname')).' '.capitalFirstLetter(getField('sname'));?><small><?php echo capitalFirstLetter(getField('status'));?></small></p>
              </li>
              <!-- Menu Footer-->
