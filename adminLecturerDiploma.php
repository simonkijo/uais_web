      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
			...
			<ul class="treeview-menu">
				...
				<li class="active"><a href="adminLecturerDiploma.php"><i class="fa fa-circle-o"></i>Ordinary Diploma</a></li>
			</ul>
		</li>
		<li class="treeview">
							...
							<div class="col-md-3">
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
									  <button type="submit" name="lec_show_d" class="btn btn-primary">Show</button>
									</div>
								</div>
							</div>
						</div>
				...
				echo	'<div class="row" style="margin:1%;">
						...
						<div class="row">
							...
							<div class="col-md-3" style="margin-bottom:2%;">
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
									  <button type="submit" name="lec_save_d" class="btn btn-primary">Save</button>
									</div>
								</div>
							</div>
						</div>';
