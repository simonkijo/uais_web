		...
		<li class="active treeview">
			...
			<ul class="treeview-menu">
				<li class="active"><a href="#"><i class="fa fa-circle-o"></i>Bachelor Degree <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
					<ul class="treeview-menu">
						<li class="active"><a href="adminCourseBachelor.php"><i class="fa fa-circle-o"></i> Course</a></li>
							...
							<div class="col-md-3" style="margin-bottom:2%;">
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
									  <button type="submit" name="co_save_b" class="btn btn-primary">Save</button>
									</div>
								</div>
							</div>
						</div>
